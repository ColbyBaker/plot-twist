...
#define PN532_PREAMBLE                (0x00) //not used, but implementation resolves to the same.
...
#define PN532_ACK_WAIT_TIME           (100)  // ms, timeout of waiting for ACK //edited from 10
